...
public class RxDownloader {
  ...
  @NonNull private LongSparseArray<PublishSubject<String>> mSubjectMap = new LongSparseArray<>();

  public static RxDownloader getInstance(@NonNull Context context) {
    if (mRxDownloader == null) mRxDownloader = new RxDownloader(context.getApplicationContext());
  ...
  @NonNull public Observable<String> download(String link, String filename) {
    return download(link, filename, "*/*");
  }

  @NonNull public Observable<String> download(String link, String filename, String mimeType) {
    return download(getDefaultRequest(link, filename, mimeType));
  }

  @NonNull public Observable<String> download(DownloadManager.Request request) {
  ...
  @NonNull private DownloadManager.Request getDefaultRequest(String link, String filename, String mimeType) {
