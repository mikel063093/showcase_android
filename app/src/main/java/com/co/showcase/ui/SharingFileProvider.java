 ...
 * <p/>
 * This {@link FileProvider} is a very simple example that handle the query of {@link
...
public class SharingFileProvider extends FileProvider {
  ...
  /**
   * Check if a projection corresponds to a {@link android.provider.MediaStore.Images.ImageColumns#ORIENTATION}
   * projection.
   *
   * @param projection the projection to check.
   * @return Returns true is the given projection corresponds to {@link android.provider.MediaStore.Images.ImageColumns#ORIENTATION},
   * false otherwise.
   */
  private boolean isMediaStoreOrientationProjection(@Nullable String[] projection) {
   ...
   *
   * @return Returns a {@link Cursor} with {@link android.provider.MediaStore.Images.ImageColumns#ORIENTATION}
   * set to 0.
   */
  @NonNull private Cursor queryMediaStoreOrientation() {
