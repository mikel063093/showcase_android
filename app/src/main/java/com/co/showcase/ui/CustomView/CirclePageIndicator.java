...
public class CirclePageIndicator extends View implements PageIndicator {
  ...
  @Override public void setViewPager(@NonNull ViewPager view) {
    if (mViewPager == view) {
      return;
    }
    if (mViewPager != null) {
  ...
  @Override public void setViewPager(@NonNull ViewPager view, int initialPosition) {
    setViewPager(view);
  ...
  @NonNull @Override public Parcelable onSaveInstanceState() {
  ...
  static class SavedState extends BaseSavedState {
    ...
    @SuppressWarnings("UnusedDeclaration") public static final Creator<SavedState> CREATOR =
        new Creator<SavedState>() {
          @NonNull @Override public SavedState createFromParcel(@NonNull Parcel in) {
            return new SavedState(in);
          }

          @NonNull @Override public SavedState[] newArray(int size) {
